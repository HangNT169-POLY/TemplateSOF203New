package com.template.demo.B4_5_ListFixCung.controller;

import com.template.demo.B4_5_ListFixCung.entity.SinhVien;
import com.template.demo.B4_5_ListFixCung.service.SinhVienService;
...
//        response.sendRedirect("/sinh-vien/hien-thi");
    ...
    private void viewUpdate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Lay vi tri tren url
        SinhVien sv = service.detailSinhVien(request.getParameter("mssv"));
    ...
    private void removeSinhVien(HttpServletRequest request, HttpServletResponse response) throws IOException {
        // Lay vi tri tren url
        service.xoaSinhVien(request.getParameter("mssv"));
        response.sendRedirect("/sinh-vien/hien-thi");
    }
